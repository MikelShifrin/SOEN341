...
class ElectronicsTDG
{
    ...
    public function deleteDesktop($electronicsId)
    {
        ...
        $sql="Delete from Desktop where Electronics_id = $electronicsId" ;
        $db = pg_connect("$host $port $dbname $credentials");
        $ret = pg_query($db, $sql);

        $sql="Delete from Electronics where Electronics_id = $electronicsId" ;
        $db = pg_connect("$host $port $dbname $credentials");
        $ret = pg_query($db, $sql);
        if (!$ret) {
            pg_close($db);
    ...
    public function deleteMonitor($electronicsId)
    {
        $login = false;
        $host        = "host = ec2-23-21-92-251.compute-1.amazonaws.com";
        $port        = "port = 5432";
        ...
        $sql="Delete from Monitor where Electronics_id = $electronicsId" ;
        $db = pg_connect("$host $port $dbname $credentials");
        $ret = pg_query($db, $sql);
    ...
    public function deleteLaptop($electronicsId)
    {
        $login = false;
        $host        = "host = ec2-23-21-92-251.compute-1.amazonaws.com";
        $port        = "port = 5432";
        ...
        $sql="Delete from Laptop where Electronics_id = $electronicsId" ;
        $db = pg_connect("$host $port $dbname $credentials");
        $ret = pg_query($db, $sql);
    ...
    public function deleteTablet($electronicsId)
    {
        $login = false;
        $host        = "host = ec2-23-21-92-251.compute-1.amazonaws.com";
        $port        = "port = 5432";
        ...
        $sql="Delete from Tablet where Electronics_id = $electronicsId" ;
        $db = pg_connect("$host $port $dbname $credentials");
        $ret = pg_query($db, $sql);
